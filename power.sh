...
'   ───╚═╝───────────────────────────\n')
echo ""
echo -e $cyan"    Developer by           $white":" $red Pyae Sone Hmoo  "

echo -e $cyan"    Github              $white":" $red https://github.com/bgmpyaesone290G"
...
echo -e $okegreen"   ====================== Tool Lest =======================    ";
        ...
        case "$option" in 
           ...
           14)  echo "fluxion"
                ...
                clear
                ;;
            q)  echo -e $yellow " Thanks For Using My Tools Good Bye  {Pyae Sone Hmoo}  !!"
                echo
                exit 0 
                ;;
        esac
